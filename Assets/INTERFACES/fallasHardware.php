...
<nav class="navbar navbar-expand-lg">
  ...
  <h1>Detección y solución de fallas (Hardware)</h1>
    ...
    <div class="grupo-formulario">
        <label for="">Tipo de equipo</label>
          <div class="form-floating containerDeteccion grupo-formulario-input">
            <input type="hidden" name="TipoDeFalla" value="Hardware">
            <select name="EquipoFalla" class="form-select w-50" id="floatingSelect" aria-label="Floating label select example" style="height: 100px">
      ...
      <div class="grupo-formulario">
        ...
        <div class="containerDescripcion grupo-formulario-input">
            <textarea onpaste="return false;" oncontextmenu="return false;" class="inputDescripcion" name="FallaDescripcion" id="" ></textarea>
        </div>
      </div>
      <div class="boton">
        ...
        if (empty($MostrarSoluciones->resultado)) {
          ...
          <p>Si encuentras una, porfavor agregala</p>
            ...
            <div class="col-sm-6">
              ...
              <input onpaste="return false;" oncontextmenu="return false;" type="text" id="inputText5" class="form-control SubirNewSolucion" name="solucionNew" >
            </div>
            <div class="boton">
            ...
            <input type="hidden" name="TipoDeFallaNew" value="Hardware">
              ...
              ?>
                <div class="form-check form-switch">
                  <input onpaste="return false;" oncontextmenu="return false;" class="form-check-input bg-success chekboxDetec" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="antecedentesID[]" value="<?php echo $fila["idAntecedentes"] ?>">
